...
function blob(e){if(!e||e.type!=='file')return null;if(!blobs[e.hash])blobs[e.hash]={hash:e.hash,size:e.size,contentBase64:e.content.toString('base64')};return e.hash}
